...
parser.add_argument('--num_trajs', type=int, default=2000)
...
obss, actions, returns, done_idxs, rtgs, timesteps, combined_graph = create_bridge(args.num_nodes, args.graph_density, args.num_trajs, args.max_traj_length, args.seed, is_directed)
vocab_size = len(combined_graph) + 1
...
trainer = Trainer(model, train_dataset, None, tconf, combined_graph, None, is_directed)

trainer.train()

eval_returns = []
eval_return = trainer.get_returns_bridge(True)
